...
If the page has any child pages, and `has_toc` is not set to `false`, this content appears as a heading above the [auto-generating list of child pages]({% link docs/disclaimer.m %}#auto-generating-table-of-contents) after the page's content.
